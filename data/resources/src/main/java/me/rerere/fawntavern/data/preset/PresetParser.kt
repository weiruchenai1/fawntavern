...
object PresetParser {
    ...
    fun parse(json: JSONObject, fileName: String = ""): StPreset {
        ...
        return StPreset(
            ...
            sendTemperature = json.optBoolean("fawntavern_send_temperature", true),
            sendTopP = json.optBoolean("fawntavern_send_top_p", true),
            sendTopK = json.optBoolean("fawntavern_send_top_k", true),
            sendFrequencyPenalty = json.optBoolean("fawntavern_send_frequency_penalty", true),
            sendPresencePenalty = json.optBoolean("fawntavern_send_presence_penalty", true),
            sendSeed = json.optBoolean("fawntavern_send_seed", true),
            sendMaxTokens = json.optBoolean("fawntavern_send_max_tokens", true),
